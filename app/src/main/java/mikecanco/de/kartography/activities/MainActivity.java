...
import mikecanco.de.kartography.CustomWindowAdapter;
import mikecanco.de.kartography.R;
import mikecanco.de.kartography.fragments.PoiListFragment;
import mikecanco.de.kartography.models.Poi;
import mikecanco.de.kartography.models.User;
...
public class MainActivity extends Activity implements
        ...
        GooglePlayServicesClient.OnConnectionFailedListener, ActionBar.TabListener {

    User user;
    ActionBar actionBar;
    ActionBar.Tab tabList;
    ...
    // end of maps maps
    private com.parse.ParseAnalytics ParseAnalytics = null;
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (myLocation != null) {
                    ...
                    myMap.setInfoWindowAdapter(new CustomWindowAdapter(MainActivity.this.getLayoutInflater(), imageStringMapMarker, getApplicationContext()));
